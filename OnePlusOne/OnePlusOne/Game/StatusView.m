...
//    self.completionsLevel.frame = SKRectSetY(self.completionsLevel.frame, size.height*completionsTop);
    ...
    self.scoreLabel.frame = SKRectSetX(self.scoreLabel.frame, CGRectGetMaxX(self.titleLabel.frame) + size.width*scoreLeft);
    ...
    self.scoreTitleLabel.frame = SKRectSetX(self.scoreTitleLabel.frame, CGRectGetMinX(self.scoreLabel.frame));
